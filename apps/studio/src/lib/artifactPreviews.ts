...
production/render/render_manifest.json	Render manifest	json	Audio And Render	Local FFmpeg draft-render manifest with input digests, intro-to-outro timeline, overlays, ffprobe media evidence, and review checklist.	Use with the MP4 for local final review; upload remains disabled.
