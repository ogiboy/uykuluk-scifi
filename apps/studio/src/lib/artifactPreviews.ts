...
production/storyboard_contact_sheet.md	Storyboard contact sheet	markdown	Render Planning	Operator contact sheet with visual rhythm, scene-to-asset map, and bookend/source-frame review paths.	Use this as review evidence; it is not render approval or voiceover approval.
...
production/render/youtube_chapters.md	YouTube chapter handoff	markdown	Audio And Render	Copy-ready local chapter draft generated from the render timeline.	Review and revise before any future upload workflow; upload remains disabled.
...
production/thumbnail_candidates.json	Thumbnail candidates	json	Final Review	Machine-readable tracked thumbnail candidates generated for manual channel preparation.	Use as local upload-prep evidence only; upload remains disabled.
