...
- read-only `/runs` index over persisted local run state with readiness/evidence status, stale or
  invalid artifact remediation, and next safe action visibility;
