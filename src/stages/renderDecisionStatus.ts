...
/**
 * Reads the local draft-render operator decision status.
 *
 * @param run - The run whose render decision should be inspected.
 * @returns The render decision status.
 */
...
/**
 * Builds the operator command for recording a render decision.
 *
 * @param runId - The run identifier.
 * @returns A copy-pasteable render-decision command template.
 */
