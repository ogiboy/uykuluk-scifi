...
import type { VoiceExecutionPreflightReceipt } from "./voiceExecutionPreflight.js";
import {
 ...
 */
export function spoolPaidVoiceResult(
 ...
 */
export function requireResultEvidenceDigest(value: string | undefined): string {
  if (!value) {
