...
const markdownFormattedLabelPattern = /`(Anlatıcı|Görsel):`/gu;

/** Repairs bounded known local-model variants into exact Turkish production labels. */
