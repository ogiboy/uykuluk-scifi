...
export function renderScriptSectionExpansionPrompt(
  ...
  return [
    ...
    "Target length: 80-110 Turkish words.",
    "Hard limit: 900 characters.",
    "Write exactly 4 complete Turkish sentences; if you need labels, keep them inside those four sentences.",
    "Sentence plan: 1) concrete visual or narrative beat; 2) cause, measurement, or uncertainty; 3) distinct consequence or decision; 4) transition or closure.",
