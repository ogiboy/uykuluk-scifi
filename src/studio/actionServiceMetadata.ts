...
const studioMutationServiceRows = [
  ...
  ["render.decide", readyForCli, "pnpm producer decide render --run <run_id> --decision <decision> --json", "recordRenderDecision", "src/stages/renderDecision.ts", "Record one local draft-render review decision."],
  ["channel-handoff.decide", readyForCli, "pnpm producer decide channel-handoff --run <run_id> --decision <decision> --json", "recordChannelHandoffDecision", "src/stages/channelHandoffDecision.ts", "Record one manual channel-handoff decision."],
