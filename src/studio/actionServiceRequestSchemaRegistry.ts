...
export const studioMutationRequestSchemaByAction = {
  ...
  "localModels.execute": localModelExecuteRequestSchema,
  "localModels.prepare": localModelPrepareRequestSchema,
  ...
  "visuals.activate-revision": visualActivateRevisionRequestSchema,
  ...
  "visuals.generate-local": localVisualGenerationRequestSchema,
  "visuals.prepare": runOnlyRequestSchema,
  "visuals.regenerate": visualRegenerationRequestSchema,
  "soundtrack.prepare": soundtrackPrepareRequestSchema,
  "soundtrack.import": soundtrackImportRequestSchema,
  "soundtrack.configure": soundtrackConfigureRequestSchema,
  "soundtrack.analyze": soundtrackAnalyzeRequestSchema,
  "soundtrack.decide": soundtrackDecisionRequestSchema,
