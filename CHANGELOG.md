...
- stabilize streamed route readiness (#166) (ebd935b)

### Documentation

- align project capability routing (#165) (e42a248)
...
- make draft-render review commands executable-only, read-only, and tamper-checked
...
- add local model evaluation and llama.cpp adapter (82ef971)
...
- add production media review actions (#89) (317726a)
...
- clarify production media review actions (#87) (5ff67fe)
...
- record source frame cadence (#85) (5b59311)

## v0.38.3 (2026-06-28)

### Fixes

- preserve approval trace evidence (#84) (2e8fa3c)
