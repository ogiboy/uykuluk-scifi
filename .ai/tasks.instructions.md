...
- Harden FFmpeg draft render visual polish; the current foundation is exact-approval-gated local MP4
  ...
  render approval ID/reference plus voiceover mode/quality/candidate classification preserved from
  approval through evidence, fail-closed `ffprobe` media validation, and an operator-readable
